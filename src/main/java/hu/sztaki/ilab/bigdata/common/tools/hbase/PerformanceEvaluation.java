...
public class PerformanceEvaluation  {
  ...
  public static final byte [] TABLE_NAME = Bytes.toBytes("kopi_index");
  public static final byte [] FAMILY_NAME = Bytes.toBytes("idx");
  public static final byte [] QUALIFIER_NAME = Bytes.toBytes("i");
